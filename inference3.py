...
def main():
    ...
    # Change Start: Use Image.LANCZOS for resizing due to Pillow 10.0.0 deprecation of Image.ANTIALIAS
...
def datagen(frames, mels, full_frames, frames_pil, cox):
    ...
    # Check if kp_extractor.detector exists before attempting to delete
    if hasattr(kp_extractor, 'detector'):
